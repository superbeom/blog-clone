...
const PostCard = ({ post }) => (
  <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
    ...
    <div className="m-8 block w-full items-center justify-center text-center lg:flex">
    ...
    <div className="cursor-pointer text-center">
      <Link href={`/post/${post.slug}`}>
        <span className="inline-block transform rounded-full bg-pink-600 px-8 py-3 text-lg font-medium text-white transition duration-500 hover:-translate-y-1">
          Continue Reading
        </span>
      </Link>
    </div>
